...
<style>
  ...
  <div class="w3-bar w3-black w3-hide-small">
    <h6 class="w3-tag">  Cosmetic</h6>
    <a href="#" class="w3-bar-item w3-button w3-right"><i class="fa fa-search"></i></a>
    <a href="#" class="w3-bar-item w3-button w3-right" onclick="window.location='admin.jsp';">For Admin</a>
  </div>

  <header class="w3-container w3-center w3-padding-48 w3-white">
    <h1 class="w3-xxxlarge"><b>COSMETIC SHOP</b></h1>
    <h6><span class="w3-tag">Welcome</span></h6>
  </header>

  <header class="w3-display-container w3-wide" id="home">
    <img class="w3-image" src="http://andreasskincare.com/wp-content/uploads/2016/12/andreas-makeup2.jpg" alt="Fashion Blog" width="1600" height="1060">
